...
\small Version 0.9.8 \quad \textemdash \quad May 20, 2026}
\date{}
...
\medskip
\noindent\textbf{Keywords:} agent memory, hash-chained ledger, BM25, reciprocal rank fusion, graph expansion, implicit edge inference, temporal knowledge graphs, retrieval-augmented generation.
\end{abstract}
